...
export class DarkHouse_Base extends Scene {
    ...
    constructor() {
        ...
        // Object Found Dictionary
        this.obj_found = {'cow': false, 'pedestal': false, 'statue': false, 'vase': false, 'bull': false, 'bench1': false, 'bench2': false};
        ...
        this.shapes = {
            ...
            cow: new Shape_From_File("assets/spot_quadrangulated.obj"),
        ...
        this.materials = {
            ...
            cow_material: new Material(new defs.Textured_Phong(1), {
                color: color(.5, .5, .5, 1),
...
export class DarkHouse extends DarkHouse_Base {
    ...
    createObjectsInRoom(context, program_state, model_transform) {
        ...
        // Center position, x, y
        this.centers[0] = [...cow_model_transform.transposed()[3], 1, 'cow'];
        this.centers[1] = [...pedestal_model_transform.transposed()[3], 1.5, 1.5, 'pedestal'];
        this.centers[2] = [...statue_model_transform.transposed()[3], 1, 2, 'statue'];
        this.centers[3] = [...vase_model_transform.transposed()[3], 1, 4, 'vase'];
        this.centers[4] = [...bull_model_transform.transposed()[3], 4, 2, 'bull'];
        this.centers[5] = [...bench1_model_transform.transposed()[3], 1.5, 5, 'bench1'];
        this.centers[6] = [...bench2_model_transform.transposed()[3], 1.5, 5, 'bench2'];
        ...
        this.detect_Collision(this.distances);
    ...
    detect_Collision(distances) {
        let object_collided = distances.filter((dist) => {
            return dist[0] < dist[2] && dist[1] < dist[3]
        });

        if (object_collided.length > 0) {
            object_collided = object_collided[0];
            this.obj_found[object_collided[4]] = true;
            if (defs.left) {
                defs.thrust[0] = -0.3;
            } else if (defs.right) {
                defs.thrust[0] = 0.3;
    ...
    // Function Object handleDetected(names of obj){
    //      set some Boolean as True
    //}
